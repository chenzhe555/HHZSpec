#
#  Be sure to run `pod spec lint iOS-HHZUtils.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/chenzhe555/iOS-HHZUtils"
  ...
  s.source       = { :git => "https://github.com/chenzhe555/iOS-HHZUtils.git", :tag => "#{s.version}" }
